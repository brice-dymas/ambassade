...
public interface DonneesActeService {
    ...
    Page<DonneesActe> findAll(String reference, String nomEnfant, LocalDate dateDuJourChiffreDeb,
                              String registre, Statut statut, String nomPere, String prenomPere,
                              String nomMere, String prenomMere, LocalDate dateNaissanceChiffreDeb, Integer annee,
