...
public interface PasseportRepository extends JpaRepository<Passeport, Long> {
    ...
    Page<Passeport> searchAll(@Param("nom") String codeISBN, @Param("prenom") String auteur,
                              ...
                              @Param("soumisLeDeb") LocalDate soumisLeDeb,@Param("soumisLeFin") LocalDate soumisLeFin,
                              @Param("delivreLeDeb") LocalDate delivreLeDeb,@Param("delivreLeFin") LocalDate delivreLeFin,
                              @Param("montant")BigDecimal montant, @Param("remarques") String remarques,
                              @Param("dateEmissionDeb") LocalDate dateEmissionDeb, @Param("dateEmissionFin") LocalDate dateEmissionFin,
                              @Param("dateExpirationDeb") LocalDate dateExpirationDeb,@Param("dateExpirationFin") LocalDate dateExpirationFin,
