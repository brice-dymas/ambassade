...
describe('Service Tests', () => {
    ...
    describe('UniteOrganisationelle Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(UniteOrganisationelleService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/unite-organisationelles';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return UniteOrganisationelle', () => {
